...
function generarFacturaHTML($idVenta, $items, $total, $metodoPago, $conexion) {
    ...
    <head>
        ...
        <title>Factura CineMax</title>
                                                                                                                                            <style>body { font-family: Arial, sans-serif; margin: 20px; color: #333; } .factura-container { max-width: 800px; margin: 0 auto; border: 2px solid #1a365d; padding: 20px; } .header { text-align: center; margin-bottom: 30px; border-bottom: 2px solid #1a365d; padding-bottom: 20px; }.header h1 { color: #1a365d; margin: 0; }.info-section { display: flex; justify-content: space-between; margin-bottom: 20px; }.info-box { flex: 1; padding: 10px; }.info-box h3 { color: #1a365d; border-bottom: 1px solid #ddd; padding-bottom: 5px; }.tabla-items { width: 100%; border-collapse: collapse; margin: 20px 0; } .tabla-items th, .tabla-items td { border: 1px solid #ddd; padding: 10px; text-align: left; } .tabla-items th { background-color: #f5f5f5; } .total-section { text-align: right; margin-top: 20px; font-size: 1.2em; font-weight: bold; }.footer { text-align: center; margin-top: 30px; color: #666; font-size: 0.9em; } .logo { font-size: 24px; font-weight: bold; color: #1a365d; }.detalle-item { background-color: #f9f9f9; }</style>
    </head>
    <body>
